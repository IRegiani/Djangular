...
from .api import AdministradorAPI, PessoaAPI, CursoAPI, TurmaAPI, AulaAPI, PessoaAulaAPI, ColaboradorTurmaAPI, AulasDaTurmaAPI, TurmasDoAlunoAPI, FaltaAPI, AulaIdAPI
